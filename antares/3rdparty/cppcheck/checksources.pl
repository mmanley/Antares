...
if (!-e "./ReadMe.cross-compile") {
	die "ERROR: $0 must be called from Antares top directory!\n";
}
...
$cppcheck = "cppcheck -j $jobs --force --auto-dealloc 3rdparty/cppcheck/antares.lst --enable=exceptRealloc,possibleError $headersDirs $dirToCheck 2> $fileToLog";
