 ...
 */
	...
	#ifndef MODULE_NAME
	//#warning MODULE_NAME not defined for Antares BT debugging tools
	#define MODULE_NAME "BT"
	#endif
	
	#ifndef SUBMODULE_NAME
	//#warning SUBMODULE_NAME not defined for Antares BT debugging tools
	#define SUBMODULE_NAME ""
	#endif
	
	#ifndef SUBMODULE_COLOR
	//#warning SUBMODULE_COLOR not defined for Antares BT debugging tools
