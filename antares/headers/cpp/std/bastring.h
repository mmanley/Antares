...
#ifdef __ANTARES__
extern "C" __antares_int32 atomic_add(volatile __antares_int32* value,
	__antares_int32 addvalue);
#endif	/* __ANTARES__ */
...
#ifdef __ANTARES__
    charT* grab () { if (selfish) return clone (); atomic_add((volatile __antares_int32*) &ref, 1); return data (); }
    void release() { if (atomic_add((__antares_int32*) &ref, -1) == 1) delete this; }
#else
