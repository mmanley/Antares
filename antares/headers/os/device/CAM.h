 ...
 *
 *
 * Definitions for the SCSI Common Access Method as implemented in Antares.
 *
...
/* End of Antares specific additions */
...
/* ---
	Vendor unique flags supported by Antares (cam_vu_flags)
--- */
