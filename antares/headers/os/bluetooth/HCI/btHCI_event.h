...
/* ANTARES Internal Events, not produced by the transport devices but 
 * by some entity of the Antares Bluetooth Stack. 
 * The MSB 0xE is chosen for this purpose
 */
 
#define HCI_ANTARES_EVENT_SERVER_QUITTING				0xE0
#define HCI_ANTARES_EVENT_DEVICE_REMOVED				0xE1
