...
/* WARNING: The following is Antares experimental API. It might be removed or
...
/* TODO: the following two calls are not part of the BeOS API, and might be
   changed or even removed for the final release of Antares R1 */
