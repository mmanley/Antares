...
#if defined(ANTARES_HOST_PLATFORM_CYGWIN)
#	ifndef __addr_t_defined
#		define __addr_t_defined
#	endif
#endif

#if defined(ANTARES_HOST_PLATFORM_CYGWIN) || defined(ANTARES_HOST_PLATFORM_SUNOS)
#ifndef DEFFILEMODE
...
#ifdef ANTARES_HOST_PLATFORM_SUNOS
#	include <limits.h>
#	ifndef NAME_MAX
...
#if defined(ANTARES_HOST_PLATFORM_FREEBSD) || defined(ANTARES_HOST_PLATFORM_DARWIN)
...
// remap strerror()
extern char* _antares_build_strerror(int errnum);

#ifndef BUILDING_ANTARES_ERROR_MAPPER

#undef strerror
#define strerror(errnum)	_antares_build_strerror(errnum)
