...
#if defined(__ANTARES_ARCH_X86) && __GNUC__ == 2
#	define __ANTARES_BEOS_COMPATIBLE	1
#endif

/* BeOS R5 compatible types */
#ifndef __ANTARES_ARCH_64_BIT
/*#ifdef __ANTARES_ARCH_X86*/
	/* TODO: This should be "#ifdef __ANTARES_BEOS_COMPATIBLE", but this will
	   break all gcc 4 C++ optional packages. I.e. switch that at a suitable
	   time.
	*/
#	define __ANTARES_BEOS_COMPATIBLE_TYPES	1
#endif
