...
typedef __antares_int32 sigset_t;
 ...
 *
 * The numbering of signals for Antares attempts to maintain
 ...
 * by Antares. However, to remain compatible with Posix and ANSI C, the type
 ...
 *
 * The 3 arguments that Antares provides to signal handlers are as follows:
...
#include __ANTARES_ARCH_HEADER(signal.h)
