/*
 * Copyright 2005-2006, Antares Inc. All Rights Reserved.
...
typedef __antares_int32 clock_t;
typedef __antares_int32 time_t;
typedef __antares_int32 suseconds_t;
typedef __antares_uint32 useconds_t;
