...
int
__antares_miibus_readreg(device_t device, int phy, int reg)
{
...
int
__antares_miibus_writereg(device_t device, int phy, int reg, int data)
{
...
void
__antares_miibus_statchg(device_t device)
{
...
void
__antares_miibus_linkchg(device_t device)
{
...
void
__antares_miibus_mediainit(device_t device)
{
