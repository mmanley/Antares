 ...
 *
 * For Antares this value is much higher, due to using another timeout scheduling
 * mechanism, which has a resolution of 1 MHz. So hz for Antares is set to
