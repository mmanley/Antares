/******************************************************************************
 *
 * Module Name: osantares - Antares OSL interfaces
 *
 *****************************************************************************/
...
ACPI_MODULE_NAME("Antares ACPI Module")

#define _COMPONENT ACPI_OS_SERVICES

// verbosity level 0 = off, 1 = normal, 2 = all
#define DEBUG_OSANTARES 0

#if DEBUG_OSANTARES <= 0
...
#ifdef _KERNEL_MODE
	// It so happens that the Antares and ACPI-CA interrupt handler routines
