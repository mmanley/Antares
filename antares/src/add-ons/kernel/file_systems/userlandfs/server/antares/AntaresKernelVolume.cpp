...
#include "AntaresKernelIORequest.h"
#include "AntaresKernelNode.h"


// NodeMap
class AntaresKernelVolume::NodeMap
	: public SynchronizedHashMap<HashKey64<ino_t>, AntaresKernelNode*> {
};


// _FileSystem
inline AntaresKernelFileSystem*
AntaresKernelVolume::_FileSystem() const
{
	return static_cast<AntaresKernelFileSystem*>(fFileSystem);
}


// constructor
AntaresKernelVolume::AntaresKernelVolume(FileSystem* fileSystem, dev_t id,
	...
	fNodes(NULL)
{
	...
	fVolume.antaresVolume = this;
}

// destructor
AntaresKernelVolume::~AntaresKernelVolume()
{
	delete fNodes;
}
...
// NewVNode
status_t
AntaresKernelVolume::NewVNode(ino_t vnodeID, void* privateNode, fs_vnode_ops* ops,
	AntaresKernelNode** _node)
{
	AutoLocker<NodeMap> _(fNodes);

	// check whether we do already know the node
	AntaresKernelNode* node = fNodes->Get(vnodeID);
	if (node != NULL)
		return B_BAD_VALUE;

	// get node capabilities
	AntaresKernelNode::Capabilities* capabilities
		= _FileSystem()->GetNodeCapabilities(ops);
	if (capabilities == NULL)
		return B_NO_MEMORY;

	// create a new node
	node = new(std::nothrow) AntaresKernelNode(this, vnodeID, privateNode, ops,
		capabilities);
	if (node == NULL) {
...
// PublishVNode
status_t
AntaresKernelVolume::PublishVNode(ino_t vnodeID, void* privateNode,
	fs_vnode_ops* ops, int type, uint32 flags, AntaresKernelNode** _node)
{
	AutoLocker<NodeMap> _(fNodes);
	...
	if (node != NULL) {
		...
		// create a new node
		node = new(std::nothrow) AntaresKernelNode(this, vnodeID, privateNode,
			ops, capabilities);
		if (node == NULL) {
			_FileSystem()->PutNodeCapabilities(capabilities);
			return B_NO_MEMORY;
...
// UndoNewVNode
void
AntaresKernelVolume::UndoNewVNode(AntaresKernelNode* node)
{
...
// UndoPublishVNode
void
AntaresKernelVolume::UndoPublishVNode(AntaresKernelNode* node)
{
	fNodes->Remove(node->id);
	delete node;
}
...
// NodeWithID
AntaresKernelNode*
AntaresKernelVolume::NodeWithID(ino_t vnodeID) const
{
...
// Mount
status_t
AntaresKernelVolume::Mount(const char* device, uint32 flags,
...
// ReadFSInfo
status_t
AntaresKernelVolume::ReadFSInfo(fs_info* info)
{
...
// WriteFSInfo
status_t
AntaresKernelVolume::WriteFSInfo(const struct fs_info* info, uint32 mask)
{
...
// GetFileMap
status_t
AntaresKernelVolume::GetFileMap(void* _node, off_t offset, size_t size,
	struct file_io_vec* vecs, size_t* count)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Lookup
status_t
AntaresKernelVolume::Lookup(void* _dir, const char* entryName, ino_t* vnid)
{
	AntaresKernelNode* dir = (AntaresKernelNode*)_dir;
...
// GetVNodeName
status_t
AntaresKernelVolume::GetVNodeName(void* _node, char* buffer, size_t bufferSize)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadVNode
status_t
AntaresKernelVolume::ReadVNode(ino_t vnid, bool reenter, void** _node, int* type,
	uint32* flags, FSVNodeCapabilities* _capabilities)
{
	...
	AntaresKernelNode* node = new(std::nothrow) AntaresKernelNode(this, vnid, NULL,
		NULL, NULL);
	if (node == NULL)
		return B_NO_MEMORY;
	ObjectDeleter<AntaresKernelNode> nodeDeleter(node);
...
// WriteVNode
status_t
AntaresKernelVolume::WriteVNode(void* _node, bool reenter)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// RemoveVNode
status_t
AntaresKernelVolume::RemoveVNode(void* _node, bool reenter)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
status_t
AntaresKernelVolume::DoIO(void* _node, void* cookie,
	const IORequestInfo& requestInfo)
{
	...
	AntaresKernelIORequest* request
		= new(std::nothrow) AntaresKernelIORequest(this, requestInfo);
	if (request == NULL)
...
status_t
AntaresKernelVolume::CancelIO(void* _node, void* cookie, int32 ioRequestID)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
	...
	// get the request
	AntaresKernelIORequest* request = _FileSystem()->GetIORequest(ioRequestID);
	if (request == NULL)
...
// IterativeIOGetVecs
status_t
AntaresKernelVolume::IterativeIOGetVecs(void* _cookie, int32 requestID,
	off_t offset, size_t size, struct file_io_vec* vecs, size_t* _count)
{
	AntaresKernelIterativeFDIOCookie* cookie
		= (AntaresKernelIterativeFDIOCookie*)_cookie;

	// get the request
	AntaresKernelIORequest* request = _FileSystem()->GetIORequest(requestID);
	if (request == NULL)
		RETURN_ERROR(B_BAD_VALUE);
...
// IterativeIOFinished
status_t
AntaresKernelVolume::IterativeIOFinished(void* _cookie, int32 requestID,
	status_t status, bool partialTransfer, size_t bytesTransferred)
{
	...
	ObjectDeleter<AntaresKernelIterativeFDIOCookie> _(cookie);
...
// IOCtl
status_t
AntaresKernelVolume::IOCtl(void* _node, void* cookie, uint32 command,
...
// SetFlags
status_t
AntaresKernelVolume::SetFlags(void* _node, void* cookie, int flags)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Select
status_t
AntaresKernelVolume::Select(void* _node, void* cookie, uint8 event,
	selectsync* sync)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Deselect
status_t
AntaresKernelVolume::Deselect(void* _node, void* cookie, uint8 event,
	selectsync* sync)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// FSync
status_t
AntaresKernelVolume::FSync(void* _node)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadSymlink
status_t
AntaresKernelVolume::ReadSymlink(void* _node, char* buffer, size_t bufferSize,
	size_t* bytesRead)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// CreateSymlink
status_t
AntaresKernelVolume::CreateSymlink(void* _dir, const char* name,
...
// Link
status_t
AntaresKernelVolume::Link(void* _dir, const char* name, void* _node)
{
	AntaresKernelNode* dir = (AntaresKernelNode*)_dir;
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Unlink
status_t
AntaresKernelVolume::Unlink(void* _dir, const char* name)
{
	AntaresKernelNode* dir = (AntaresKernelNode*)_dir;
...
// Rename
status_t
AntaresKernelVolume::Rename(void* _oldDir, const char* oldName, void* _newDir,
	const char* newName)
{
	AntaresKernelNode* oldDir = (AntaresKernelNode*)_oldDir;
	AntaresKernelNode* newDir = (AntaresKernelNode*)_newDir;
...
// Access
status_t
AntaresKernelVolume::Access(void* _node, int mode)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadStat
status_t
AntaresKernelVolume::ReadStat(void* _node, struct stat* st)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// WriteStat
status_t
AntaresKernelVolume::WriteStat(void* _node, const struct stat *st, uint32 mask)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Create
status_t
AntaresKernelVolume::Create(void* _dir, const char* name, int openMode, int mode,
...
// Open
status_t
AntaresKernelVolume::Open(void* _node, int openMode, void** cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Close
status_t
AntaresKernelVolume::Close(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// FreeCookie
status_t
AntaresKernelVolume::FreeCookie(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// Read
status_t
AntaresKernelVolume::Read(void* _node, void* cookie, off_t pos, void* buffer,
...
// Write
status_t
AntaresKernelVolume::Write(void* _node, void* cookie, off_t pos,
...
// CreateDir
status_t
AntaresKernelVolume::CreateDir(void* _dir, const char* name, int mode)
{
	AntaresKernelNode* dir = (AntaresKernelNode*)_dir;
...
// RemoveDir
status_t
AntaresKernelVolume::RemoveDir(void* _dir, const char* name)
{
	AntaresKernelNode* dir = (AntaresKernelNode*)_dir;
...
// OpenDir
status_t
AntaresKernelVolume::OpenDir(void* _node, void** cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// CloseDir
status_t
AntaresKernelVolume::CloseDir(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// FreeDirCookie
status_t
AntaresKernelVolume::FreeDirCookie(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadDir
status_t
AntaresKernelVolume::ReadDir(void* _node, void* cookie, void* buffer,
...
// RewindDir
status_t
AntaresKernelVolume::RewindDir(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// OpenAttrDir
status_t
AntaresKernelVolume::OpenAttrDir(void* _node, void** cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// CloseAttrDir
status_t
AntaresKernelVolume::CloseAttrDir(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// FreeAttrDirCookie
status_t
AntaresKernelVolume::FreeAttrDirCookie(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadAttrDir
status_t
AntaresKernelVolume::ReadAttrDir(void* _node, void* cookie, void* buffer,
	size_t bufferSize, uint32 count, uint32* countRead)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// RewindAttrDir
status_t
AntaresKernelVolume::RewindAttrDir(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// CreateAttr
status_t
AntaresKernelVolume::CreateAttr(void* _node, const char* name, uint32 type,
...
// OpenAttr
status_t
AntaresKernelVolume::OpenAttr(void* _node, const char* name, int openMode,
	void** cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// CloseAttr
status_t
AntaresKernelVolume::CloseAttr(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// FreeAttrCookie
status_t
AntaresKernelVolume::FreeAttrCookie(void* _node, void* cookie)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadAttr
status_t
AntaresKernelVolume::ReadAttr(void* _node, void* cookie, off_t pos,
...
// WriteAttr
status_t
AntaresKernelVolume::WriteAttr(void* _node, void* cookie, off_t pos,
	const void* buffer, size_t bufferSize, size_t* bytesWritten)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// ReadAttrStat
status_t
AntaresKernelVolume::ReadAttrStat(void* _node, void* cookie,
	struct stat *st)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// WriteAttrStat
status_t
AntaresKernelVolume::WriteAttrStat(void* _node, void* cookie,
...
// RenameAttr
status_t
AntaresKernelVolume::RenameAttr(void* _oldNode, const char* oldName,
	void* _newNode, const char* newName)
{
	AntaresKernelNode* oldNode = (AntaresKernelNode*)_oldNode;
	AntaresKernelNode* newNode = (AntaresKernelNode*)_newNode;
...
// RemoveAttr
status_t
AntaresKernelVolume::RemoveAttr(void* _node, const char* name)
{
	AntaresKernelNode* node = (AntaresKernelNode*)_node;
...
// OpenIndexDir
status_t
AntaresKernelVolume::OpenIndexDir(void** cookie)
{
...
// CloseIndexDir
status_t
AntaresKernelVolume::CloseIndexDir(void* cookie)
{
...
// FreeIndexDirCookie
status_t
AntaresKernelVolume::FreeIndexDirCookie(void* cookie)
{
...
// ReadIndexDir
status_t
AntaresKernelVolume::ReadIndexDir(void* cookie, void* buffer,
	size_t bufferSize, uint32 count, uint32* countRead)
{
...
// RewindIndexDir
status_t
AntaresKernelVolume::RewindIndexDir(void* cookie)
{
...
// CreateIndex
status_t
AntaresKernelVolume::CreateIndex(const char* name, uint32 type, uint32 flags)
{
...
// RemoveIndex
status_t
AntaresKernelVolume::RemoveIndex(const char* name)
{
...
// StatIndex
status_t
AntaresKernelVolume::ReadIndexStat(const char *name, struct stat *st)
{
...
// OpenQuery
status_t
AntaresKernelVolume::OpenQuery(const char* queryString, uint32 flags,
...
// CloseQuery
status_t
AntaresKernelVolume::CloseQuery(void* cookie)
{
...
// FreeQueryCookie
status_t
AntaresKernelVolume::FreeQueryCookie(void* cookie)
{
...
// ReadQuery
status_t
AntaresKernelVolume::ReadQuery(void* cookie, void* buffer, size_t bufferSize,
...
// RewindQuery
status_t
AntaresKernelVolume::RewindQuery(void* cookie)
{
...
// _InitCapabilities
void
AntaresKernelVolume::_InitCapabilities()
{
