/*
	Antares S3 Savage driver adapted from the X.org Savage driver.

	Copyright (C) 1994-2000 The XFree86 Project, Inc.	All Rights Reserved.
	Copyright (c) 2003-2006, X.Org Foundation

	Copyright 2007-2008 Antares, Inc.  All rights reserved.
...
Savage_WriteMode(const DisplayModeEx& mode, const SavageRegRec& regRec)
{
	...
	// CR5F to zero so that the ProSavage chips will start up when Antares boot
