OpenSound media addon for BeOS and Antares.
...
* The drivers and media node addon should work in R5, dano/Zeta, and Antares without trouble. On Antares be sure to have a kernel newer than 2007/08/02, previous versions had a bug in open_module_list() preventing the drivers to be found.
