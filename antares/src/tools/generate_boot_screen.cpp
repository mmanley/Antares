/*
 *	Copyright (c) 2008, Antares, Inc. All rights reserved.
...
//! Antares boot splash image generator/converter
...
main(int argc, char* argv[])
{
	...
	fputs("// This file was generated by the generate_boot_screen Antares build "
		"tool.\n\n", sOutput);
