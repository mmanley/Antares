...
#	if defined(ANTARES_HOST_PLATFORM_FREEBSD) \
		|| defined(ANTARES_HOST_PLATFORM_DARWIN)
#		include <sys/ioctl.h>
#		include <sys/stat.h>
#		include <sys/disk.h>
#		ifndef ANTARES_HOST_PLATFORM_DARWIN
#			include <sys/disklabel.h>
#		endif
#	elif defined(ANTARES_HOST_PLATFORM_CYGWIN)
#		include <sys/ioctl.h>
#		include <sys/stat.h>
#	elif defined(ANTARES_HOST_PLATFORM_LINUX)
...
fssh_ioctl(int fd, unsigned long op, ...)
{
	...
	switch (op) {
		case FSSH_B_GET_GEOMETRY:
		{
			...
			#elif ANTARES_HOST_PLATFORM_FREEBSD
			{
			...
			#elif ANTARES_HOST_PLATFORM_DARWIN
			{
