...
#ifdef ANTARES_HOST_PLATFORM_BEOS
	#include <ByteOrder.h>
#else
	#include <arpa/inet.h>
#endif
...
"\n"
"Finds the antares revision section in ELF object file <file> and replaces the\n"
...
main(int argc, const char* const* argv)
{
	...
	try {
		...
		// find antares revision section
		SectionInfo info;
		if (!elfObject.FindSectionByName("_antares_revision", info)) {
			fprintf(stderr, "antares revision section not found\n");
			exit(1);
		}
