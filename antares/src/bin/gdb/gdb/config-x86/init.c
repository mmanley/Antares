...
extern initialize_file_ftype _initialize_i386_antares_tdep;
...
extern initialize_file_ftype _initialize_antares_nat;
...
initialize_all_files (void)
{
  ...
  _initialize_i386_antares_tdep ();
  _initialize_solib ();
  _initialize_antares_solib ();
  _initialize_symfile_mem ();
  _initialize_ser_hardwire ();
  _initialize_ser_pipe ();
  _initialize_ser_tcp ();
  _initialize_antares_nat ();
  _initialize_remote ();
  _initialize_dcache ();
