/*
 * Copyright 2003-2009, Antares. All rights reserved.
...
static const char* kSettingsFile = "x-vnd.Antares-desklink";
	...
	switch (message->what) {
		case B_ABOUT_REQUESTED:
			(new BAlert("About Volume Control", "Volume Control\n"
					...
					"Copyright " B_UTF8_COPYRIGHT "2003-2009, Antares",
				"OK"))->Go(NULL);
			break;

		case kMsgOpenMediaPlayer:
			_Launch("MediaPlayer", "application/x-vnd.Antares-MediaPlayer",
				B_SYSTEM_APPS_DIRECTORY, "MediaPlayer");
			break;

		case kMsgOpenMediaSettings:
			_Launch("Media Preferences", "application/x-vnd.Antares-Media",
				B_SYSTEM_PREFERENCES_DIRECTORY, "Media");
			break;

		case kMsgOpenSoundSettings:
			_Launch("Sounds Preferences", "application/x-vnd.Antares-Sounds",
