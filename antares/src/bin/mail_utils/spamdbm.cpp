 ...
 * Mostly updated the tree to Be/Antares style identifier naming conventions.  I
 * have a few more things to work out, mostly in mail_util.h, and then I'm
 * proceeding to jamify the build system.  Then we go into Antares CVS.
 *
...
".  $Id: spamdbm.cpp 30630 2009-05-05 01:31:01Z bga $  $HeadURL: http://svn.antares-os.org/antares/antares/trunk/src/bin/mail_utils/spamdbm.cpp $");
  OutputStream << "\n"
