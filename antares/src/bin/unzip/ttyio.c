...
#if (defined(__BEOS__) || defined(__ANTARES__))                /* why yes, we do */
...
#if (defined(UNIX) || (defined(__BEOS__) || defined(__ANTARES__)))
#ifdef MORE
...
#if (defined(UNIX) || defined(__MINT__) || (defined(__BEOS__) || defined(__ANTARES__)))
