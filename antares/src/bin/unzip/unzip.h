...
#  endif
#endif
#if (defined(CMS_MVS) || (defined(__BEOS__) || defined(__ANTARES__)))  /* || defined(CONVEX) */
#  ifndef PROTO
#    define PROTO
#  endif
#  ifndef MODERN
...
#if ((defined(__BEOS__) || defined(__ANTARES__)) || defined(MACOS) || defined(HAS_JUNK_EXTRA_FIELD_OPTION))
...
#if ((defined(__BEOS__) || defined(__ANTARES__)) || defined(TANDEM) || defined(THEOS) || defined(UNIX))
