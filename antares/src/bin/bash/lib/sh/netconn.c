...
isnetconn (fd)
     int fd;
{
#if defined (HAVE_GETPEERNAME) && !defined (SVR4_2) && !defined (__BEOS__) && !defined(__ANTARES__)
  int rv;
  socklen_t l;
  struct sockaddr sa;
...
#else /* !HAVE_GETPEERNAME || SVR4_2 || __BEOS__ || __ANTARES__ */
...
#  else /* !SVR4 && !SVR4_2 */
#    if defined (S_ISSOCK) && !defined (__BEOS__) && !defined(__ANTARES__)
  struct stat sb;

  if (fstat (fd, &sb) < 0)
    return (0);
  return (S_ISSOCK (sb.st_mode));
#    else /* !S_ISSOCK || __BEOS__ || __ANTARES__ */
  return (0);
#    endif /* !S_ISSOCK || __BEOS__ || __ANTARES__ */
#  endif /* !SVR4 && !SVR4_2 */
#endif /* !HAVE_GETPEERNAME || SVR4_2 || __BEOS__ || __ANTARES__ */
}
