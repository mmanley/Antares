/*
 * Copyright (c) 2004-2010, Antares, Inc.
...
const static char *kKernelName = "kernel_" ANTARES_ARCH;


// Antares SVN revision. Will be set when copying the kernel to the image.
// Lives in a separate section so that it can easily be found.
static uint32 sAntaresRevision __attribute__((section("_antares_revision")));
...
uint32
get_antares_revision(void)
{
	return sAntaresRevision;
}
