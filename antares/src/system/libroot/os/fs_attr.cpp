...
{
	// TODO: move this documentation into the Antares book!

	// NOTE: This call is deprecated in Antares and has a number of problems:
	...
	// chunks.
	// The new Antares way is to use fs_open_attr() to get a regular file handle
