	...
	fSafeMode(false)
{
	...
	if (get_system_info(&info) == B_OK
		&& (info.abi & B_ANTARES_ABI_MAJOR)
			!= (B_ANTARES_ABI & B_ANTARES_ABI_MAJOR)) {
			switch (B_ANTARES_ABI & B_ANTARES_ABI_MAJOR) {
				case B_ANTARES_ABI_GCC_2:
					fABISubDirectory = "gcc2";
					break;
				case B_ANTARES_ABI_GCC_4:
		...
		case B_NODE_MONITOR:
		{
			...
			switch (opcode) {
				case B_ENTRY_CREATED:
				{
					...
					// TODO: make this better (possible under Antares)
					snooze(100000);
