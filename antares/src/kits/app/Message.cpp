/*
 * Copyright 2005-2009, Antares Inc. All rights reserved.
...
BMessage::_InitHeader()
{
	...
	fHeader->format = MESSAGE_FORMAT_ANTARES;
...
BMessage::Unflatten(const char *flatBuffer)
{
	...
	if (format != MESSAGE_FORMAT_ANTARES)
	...
	if (fHeader->format != MESSAGE_FORMAT_ANTARES
...
#ifndef ANTARES_TARGET_PLATFORM_LIBBE_TEST
	...
	int32 token, bigtime_t timeout)
{
	...
	if (magic == MESSAGE_FORMAT_ANTARES || magic == MESSAGE_FORMAT_ANTARES_SWAPPED) {
