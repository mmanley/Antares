...
/*!
	...
	Instead of putting this functionality into BAppFileInfo (as done in Antares),
...
#if !defined(ANTARES_HOST_PLATFORM_DANO) && !defined(ANTARES_HOST_PLATFORM_BEOS) && !defined(ANTARES_HOST_PLATFORM_BONE)
