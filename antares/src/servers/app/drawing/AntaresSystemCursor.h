#ifndef ANTARES_SYSTEM_CURSOR_H
#define ANTARES_SYSTEM_CURSOR_H

#include <GraphicsDefs.h>

const uint32 kAntaresCursorWidth = 18;
const uint32 kAntaresCursorHeight = 18;
const color_space kAntaresCursorFormat = B_RGBA32;

const unsigned char kAntaresCursorBits[] = {
