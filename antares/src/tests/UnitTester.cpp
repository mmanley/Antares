...
int main(int argc, char *argv[]) {
	UnitTesterShell shell("Antares Unit Testing Framework", new SemaphoreSyncObject);
...
UnitTesterShell::PrintDescription(int argc, char *argv[]) {
	...
	cout << "and the like that comprise Antares." << endl;
}

void
UnitTesterShell::PrintValidArguments() {
	BTestShell::PrintValidArguments();
	cout << indent << "-antares       Runs tests linked against our Antares libraries (*default*)" << endl;
