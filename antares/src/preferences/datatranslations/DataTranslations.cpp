/*
 * Copyright 2002-2010, Antares Inc. All rights reserved.
...
const char* kApplicationSignature = "application/x-vnd.Antares-DataTranslations";
...
DataTranslationsApplication::AboutRequested()
{
	BAlert* alert = new BAlert("about", "DataTranslations\n\twritten by Oliver "
		"Siebenmarck and others\n\tCopyright 2002-2010, Antares Inc. All rights "
		"reserved.\n", "OK");
