/*
 * Copyright (c) 2005-2009, Antares, Inc.
...
AboutView::_CreateCreditsView()
{
	...
	snprintf(string, sizeof(string),
		COPYRIGHT_STRING "2001-%ld The Antares project. ", year);

	fCreditsView->SetFontAndColor(be_plain_font, B_FONT_ALL, &kDarkGrey);
	fCreditsView->Insert(string);

	fCreditsView->SetFontAndColor(be_plain_font, B_FONT_ALL, &kDarkGrey);
	fCreditsView->Insert(TR("The copyright to the Antares code is property of "
		"Antares, Inc. or of the respective authors where expressly noted "
		"in the source."
		"\n\n"));

	fCreditsView->SetFontAndColor(be_plain_font, B_FONT_ALL, &kLinkBlue);
	fCreditsView->InsertHyperText("http://www.antares-os.org",
		new URLAction("http://www.antares-os.org"));
	fCreditsView->Insert("\n\n");
	...
	fCreditsView->Insert(TR("The Antares-Ports team\n"));
	fCreditsView->Insert(TR("The Antaresware team and their bounty program\n"));
	...
	// Antares license
	fCreditsView->Insert(TR("The code that is unique to Antares, especially the "
