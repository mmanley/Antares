/*	PROJECT:		3Dmov
	...
	DESCRIPTION:	Antares version of the famous BeInc demo 3Dmov.
	
					TODO:
					There is a bug in Antares which doesn't allow a 2nd BGLView to be created.
...
void MainWindow :: MessageReceived(BMessage *message)
{
	switch (message->what)
	{
		...
		/*	TODO - Due to a bug when creating a 2nd BGLView in Antares, I've decided to spawn a new window
