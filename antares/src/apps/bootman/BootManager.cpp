/*
 * Copyright 2008-2009, Antares, Inc. All rights reserved.
...
static const char* kSignature = "application/x-vnd.Antares-bootman";
...
{
	BAlert *alert = new BAlert("about", "Antares Boot Manager\n\n"
		"written by\n"
		"\tDavid Dengg\n"
		"\tMichael Pfeiffer\n"
		"\n"
		"Copyright 2008-10, Antares Inc.\n", "OK");
