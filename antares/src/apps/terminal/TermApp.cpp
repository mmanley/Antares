/*
 * Copyright 2001-2009, Antares, Inc. All rights reserved.
...
{ 
	...
	if (!strcmp(mimetype, "text/x-antares-shscript")){
		// Not implemented.
		//    beep();
		return;
	}
...
#ifdef __ANTARES__
	// use BClipboard - it supports atomic access in Antares
...
{
	fprintf(stderr, "Antares Terminal\n"
		"Copyright 2001-2009 Antares, Inc.\n"
