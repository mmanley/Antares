/*
 * Copyright 2007-2010, Antares, Inc. All rights reserved.
 ...
 */
#if defined(ANTARES_TARGET_PLATFORM_BEOS) || \
	defined(ANTARES_TARGET_PLATFORM_BONE) || \
	defined(ANTARES_TARGET_PLATFORM_LIBBE_TEST)
