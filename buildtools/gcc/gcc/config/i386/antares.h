/* Definitions for Intel x86 running Antares
...
#define TARGET_VERSION fprintf (stderr, " (i386 Antares/ELF)");
...
#undef	LINK_SPEC
#define LINK_SPEC "-m elf_i386_antares -shared -Bsymbolic %{nostart:-e 0} %{shared:-e 0} %{!shared: %{!nostart: -no-undefined}}"
