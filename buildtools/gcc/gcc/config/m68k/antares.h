/* Definitions for Motorola 68k running Antares
...
#define TARGET_VERSION fprintf (stderr, " (68k Antares/ELF)");
...
#undef	LINK_SPEC
/*#define LINK_SPEC "%{!o*:-o %b} -m elf_m68k_antares -shared -no-undefined -Bsymbolic %{nostart:-e 0}"*/
