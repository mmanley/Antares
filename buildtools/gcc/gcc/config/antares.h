/* Definitions of target machine for GCC.
   Common Antares definitions for all architectures.
...
/* Antares uses lots of multichars, so don't warn about them unless the
...
/* LIB_SPEC for Antares */
#undef LIB_SPEC
#define LIB_SPEC "-lroot"

/* gcc runtime lib is built into libroot.so on Antares */
...
/* For native compiler, use standard Antares include file search paths
   rooted in /boot/develop/headers.  For a cross compiler, don't
   expect the host to use the Antares directory scheme, and instead look
   for the Antares include files relative to TOOL_INCLUDE_DIR.  Yes, we
...
#define INCLUDE_DEFAULTS \
    ...
    { "/boot/develop/headers/os/coredata", 0, 0, 0, 0, 0 }, \
    ...
    { "/boot/develop/headers/os/registry", 0, 0, 0, 0, 0 }, \
...
/* Antares doesn't have a separate math library.  */
#define MATH_LIBRARY ""

/* Antares headers are C++-aware (and often use C++).  */
