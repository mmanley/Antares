/*	Definitions for ARM running Antares systems using ELF
...
#define TARGET_VERSION fprintf (stderr, " (ARM Antares/ELF)");
...
/* Use the default LIBGCC_SPEC, not the empty version in antares.h, as we
